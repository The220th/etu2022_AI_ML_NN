...
![Рисунок 1 — Пример выполнения программы с h1](./imgs/h1_ex.png)

![Рисунок 2 — Пример выполнения программы c h2](./imgs/h2_ex.png)

Эксперементальный замер по времени и памяти при выполнении скрипта представлен на рисунке 3.

![Рисунок 3 — Замер использования процессорного времени и памяти, слева c h1, справа c h2](./imgs/h1_h2_time_mem_used.png)
...
В ходе выполнения лабораторной работы были изучены некоторые стратегии информированного поиска. Была реализована стратегия A star и использованы 2 разные эвристические функции: число фишек, находящихся в неверной позиции и сумма Манхэттенских расстояний фишек от их целевых позиций. Затем был проведён эксперемент, после которого результаты были сравнены с результатами стратегий неинформированного поиска. В итоге можно сделать несколько выводов:
